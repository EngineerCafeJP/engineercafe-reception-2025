...
export const LeaveSeatConfirmModalBox: React.FC<LeaveSeatConfirmModalBoxProps> = ({ seat, seatUsage, onClose, onNextButtonClick }) => {
  return (
    <div className="modal-box p-[0] border-2 border-warning">
      <div className='bg-warning text-[1.25rem] font-[800] text-primary-content h-[50px] flex items-center justify-center'>
        退席確認
      </div>
